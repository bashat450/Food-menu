...
public class Drinks {
	public void foodInfo() {       
		...
		String[] s ={"Virgin Cocktails        ","Hot Toddy             ","Dirty Martini         ","Lime Daiquiri         ","Sour Apple Martini       ","Bloody Mary            ","Amaretto Sour         ","Dragon Fruit Martini         ","Panty Ripper           ","Go to Payment         "};
